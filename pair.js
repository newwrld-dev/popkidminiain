...
const captionText = '𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐏𝐎𝐏𝐊𝐈𝐃';
const footerText = '𝐏𝐎𝐏𝐊𝐈𝐃 𝐌𝐈𝐍𝐈𝐁𝐎𝐓';

const buttonMessage = {
    image: { url: "https://files.catbox.moe/j4l6tf.jpg" },
    caption: captionText,
    footer: footerText,
    buttons,
    headerType: 1
...
`;
        ...
        buttons: [
            {
                ...
                nativeFlowInfo: {
                    ...
                    paramsJson: JSON.stringify({
                        ...
                        sections: [
                            {
                                title: `𝐏𝐎𝐏𝐊𝐈𝐃 𝐌𝐃.𝐅𝐑𝐄𝐄 𝐁𝐎𝐓`,
                                highlight_label: '',
                                rows: [
                                    {
                                        title: 'MENU 📌',
                                        description: '𝐏𝐎𝐏𝐊𝐈𝐃 𝐃𝐄𝐕𝐒',
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *𝐏𝐎𝐏𝐊𝐈𝐃 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "POPKID-𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃" }),
